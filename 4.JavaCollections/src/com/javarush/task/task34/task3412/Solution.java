...
public class Solution {
    ...
    public void calculateAndSetValue3(long value) {
        ...
        if (value > Integer.MAX_VALUE) {
            ...
            logger.debug("New value1:" + value1); //1
        } else {
            value1 = (int) value;
            logger.debug("New value1:" + value1); //2
        }
    }
    ...
    public void setValue1(int value1) {
        logger.debug("setValue1:" + value1); //3
        this.value1 = value1;
    }

    public void setValue2(String value2) {
        logger.debug("setValue2:" + value2); //4
        this.value2 = value2;
    }

    public void setValue3(Date value3) {
        logger.debug("setValue3:" + value3.toString()); //5
        this.value3 = value3;
    }
}