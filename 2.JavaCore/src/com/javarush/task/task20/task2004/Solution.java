...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            this.i = Integer.parseInt(reader.readLine());//implement this method - реализуйте этот метод
            this.j = Integer.parseInt(reader.readLine());//implement this method - реализуйте этот метод
